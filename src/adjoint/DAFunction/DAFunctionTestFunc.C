...
defineTypeNameAndDebug(DAFunctionTestFunc, 0);
addToRunTimeSelectionTable(DAFunction, DAFunctionTestFunc, dictionary);
// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //

DAFunctionTestFunc::DAFunctionTestFunc(
    const fvMesh& mesh,
...
scalar DAFunctionTestFunc::calcFunction()
{
    /*
    Description:
    ...
    */
    ...
    {
        FatalErrorIn("DAFunctionTestFunc::calcFunction")
